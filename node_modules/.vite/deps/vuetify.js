import {
  ...
  createGoTo,
  useGoTo
} from "./chunk-NVOSRV5A.js";
import {
  DisplaySymbol,
  createDisplay,
  useDisplay
} from "./chunk-JVRX3Q4M.js";
import {
  useLayout
} from "./chunk-UTHPSHBH.js";
import {
  IconSymbol,
  createIcons
...
import {
  ...
  useLocale,
  useRtl
} from "./chunk-NE6J3XIO.js";
import "./chunk-A54JFIXR.js";
import "./chunk-2IMLTX2M.js";
import {
  ThemeSymbol,
  createTheme,
  useTheme
} from "./chunk-AXKPDEF7.js";
import "./chunk-YM4MHLMP.js";
import {
  DefaultsSymbol,
  IN_BROWSER,
  createDefaults,
...
function getWeekArray(date2, locale, firstDayOfWeek) {
  ...
  const first = (_a = firstDayOfWeek != null ? firstDayOfWeek : firstDay[locale.slice(-2).toUpperCase()]) != null ? _a : 0;
...
function startOfWeek(date2, locale, firstDayOfWeek) {
  var _a;
  const day = (_a = firstDayOfWeek != null ? firstDayOfWeek : firstDay[locale.slice(-2).toUpperCase()]) != null ? _a : 0;
...
function endOfWeek(date2, locale) {
  var _a;
  const d = new Date(date2);
  const lastDay = (((_a = firstDay[locale.slice(-2).toUpperCase()]) != null ? _a : 0) + 6) % 7;
...
function getWeekdays(locale, firstDayOfWeek) {
  var _a;
  const daysFromSunday = (_a = firstDayOfWeek != null ? firstDayOfWeek : firstDay[locale.slice(-2).toUpperCase()]) != null ? _a : 0;
...
function format(value, formatString, locale, formats) {
  var _a;
  const newDate = (_a = date(value)) != null ? _a : new Date();
...
function createInstance(options, locale) {
  ...
  const instance = reactive(typeof options.adapter === "function" ? new options.adapter({
    locale: (_a = options.locale[locale.current.value]) != null ? _a : locale.current.value,
    formats: options.formats
  }) : options.adapter);
  watch(locale.current, (value) => {
    var _a2, _b;
    instance.locale = (_b = (_a2 = options.locale[value]) != null ? _a2 : value) != null ? _b : instance.locale;
  });
  return instance;
}
function useDate() {
